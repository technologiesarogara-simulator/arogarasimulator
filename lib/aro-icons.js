...
(function () {
  ...
  var P = {
    ...
    /* ── 3D viewer capability grid (landing page) ────────────────────── */
    piping:    '<path d="M3 8h6a5 5 0 0 1 5 5v7"/><path d="M3 5.6v4.8"/><path d="M11 20.6h6"/>',
    valve:     '<path d="M3.4 8.4 12 12 3.4 15.6z"/><path d="M20.6 8.4 12 12l8.6 3.6z"/><path d="M12 12V6"/><path d="M8.8 4.2h6.4"/>',
    flange:    '<circle cx="12" cy="12" r="7.2"/><circle cx="12" cy="6.2" r=".9"/><circle cx="17.8" cy="12" r=".9"/><circle cx="12" cy="17.8" r=".9"/><circle cx="6.2" cy="12" r=".9"/>',
    gauge:     '<circle cx="12" cy="13" r="7.6"/><path d="M12 13 15.6 9"/><path d="M12 5.4V3.8"/><path d="M6.4 8.6 5.2 7.4"/><path d="M17.6 8.6 18.8 7.4"/>',
    orbit:     '<ellipse cx="12" cy="12" rx="9" ry="4.6" transform="rotate(-18 12 12)"/><circle cx="12" cy="12" r="1.8"/><path d="m19.4 8.8 1.4-.4-.2 1.6"/>'
  };
