...
(function () {
  ...
  var PIPE_NPS = {
    ...
    14: { od: 14.000, label: '14"' },
    16: { od: 16.000, label: '16"' },
    18: { od: 18.000, label: '18"' },
    20: { od: 20.000, label: '20"' },
    24: { od: 24.000, label: '24"' }
  };
  ...
  /* Get formatted nozzle schedule string (NPS + Schedule + OD) or fallback to diameter */
  function getNozzleSpec(npsFieldId, diamFieldId, defaultD) {
    ...
    if (npsField && npsField.value && PIPE_NPS[npsField.value]) {
      var npsLabel = PIPE_NPS[npsField.value].label;
      var od = PIPE_NPS[npsField.value].od;
      var sch = schField ? schField.value : '—';
      return npsLabel + '" NPS ' + sch + ' (OD ' + od.toFixed(2) + '")';
    }
