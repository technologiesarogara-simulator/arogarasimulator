...
(function () {
  ...
  function panelHTML() {
    ...
    h += '<details class="pump-accordion" id="tk-manual">'
      ...
      + 'stress is entered for a user-defined material.</li>'
      ...
      + '(API 650 sets a flat minimum, noted on the drawing); E is the weld joint efficiency used directly in the '
      + 'shell formula.</li>'
      + '</ol>'
      ...
      + 'its substitution, the weight take-off, every design check and the bill of material, in whichever unit '
      + 'system is active. <b>DRAWING / BOM</b> produces the general-arrangement drawing &mdash; elevation with '
      + 'every level dimensioned and called out, plan view with nozzle positions, the design-data and level-schedule '
      + 'tables, the title block and the same bill of material.</p>'
