...
(function () {
  ...
  function panelHTML() {
    ...
    h += '<div id="tk-matuser" style="display:none;">'
      + two(fld('Material density ρ', 'tk-matrho', 'kg/m³', '', '1'),
            fld('Allowable stress S', 'tk-matS', 'MPa', '', '1'))
      + fld('Material roughness ε', 'tk-matrough', 'mm', '', '0.001') + '</div>';
  ...
  function updateMatInfo() {
    ...
    el.textContent = 'ρ ' + lib.rho + ' kg/m³ · allowable stress S ' + lib.S + ' MPa · roughness ' + lib.rough + ' mm';
  }
