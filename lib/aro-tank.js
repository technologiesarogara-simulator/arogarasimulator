...
(function () {
  ...
  function report() {
    ...
    b += '<div style="text-align:center;margin-bottom:14px;"><div style="font-size:18px;font-weight:800;color:#ea580c;">AROGARA — STORAGE TANK DESIGN REPORT</div><div style="font-size:10px;color:#64748b;">AROGARA TECHNOLOGIES | API 650 DESIGN BASIS</div></div>';
