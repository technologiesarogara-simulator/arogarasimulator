...
(function () {
  ...
  function manualHTML() {
    ...
    h += '<h4 class="aro-doc-h">AUTO vs MANUAL &mdash; the P&amp;ID workbench</h4>'
      ...
      + '<p>The <b>MOVE / PAN</b> tool drags the whole 2D drawing to a new spot on the canvas without touching '
      + 'anything on it; in the 3D view, the <b>MOVE VIEW</b> toggle switches the normal orbit-drag to slide the '
      + 'whole view instead. A <b>BACKGROUND</b> colour swatch next to it sets the canvas/3D background directly.</p>';
