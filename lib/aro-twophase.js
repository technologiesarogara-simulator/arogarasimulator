...
(function () {
  ...
  function panelHTML() {
    ...
    h += '<div class="panel" style="max-height:calc(100vh - 190px);overflow-y:auto;">'
      ...
      + '<div class="panel-body">'
      + '<div id="tp2-3dblock">' + '<div style="font-family:var(--font-mono);font-size:9.5px;color:#94a3b8;text-align:center;margin-bottom:4px;">3D FLOW-REGIME SIMULATION — LIVE · DRAG TO ROTATE · CTRL/&#8984;+SCROLL TO ZOOM</div>'
