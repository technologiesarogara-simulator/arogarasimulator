...
(function () {
  ...
  var css = ''
    ...
    + '.aro-feat .ic{display:flex;align-items:center;justify-content:center;width:30px;height:30px;flex:none;border-radius:9px;color:#ff9d66;background:linear-gradient(135deg,rgba(255,117,56,.16),rgba(42,82,190,.16));border:1px solid rgba(126,162,255,.18);}'
    ...
    + '.aro-tabs{display:flex;gap:6px;padding:4px;border-radius:12px;background:rgba(4,9,22,.6);border:1px solid rgba(126,162,255,.14);margin:0 0 20px;}'
    + '.aro-tab{flex:1;text-align:center;padding:9px 10px;border-radius:9px;font-size:12.5px;font-weight:600;color:#8fa6d4;cursor:pointer;border:none;background:none;font-family:inherit;letter-spacing:.03em;transition:background .18s,color .18s;}'
    ...
    + '.aro-pw-eye{position:absolute;right:10px;top:50%;transform:translateY(-50%);background:none;border:none;color:#7f96c2;cursor:pointer;font-size:14px;padding:2px 4px;}'
    + '.aro-meter{height:4px;border-radius:3px;background:rgba(126,162,255,.14);margin-top:7px;overflow:hidden;}'
    + '.aro-meter i{display:block;height:100%;width:0;border-radius:3px;transition:width .25s,background .25s;}'
    + '.aro-forgot{display:block;text-align:right;margin-top:-8px;margin-bottom:14px;font-size:12px;color:#7ea2ff;cursor:pointer;}'
    + '.aro-google{display:flex;align-items:center;justify-content:center;gap:10px;width:100%;padding:12px;border-radius:11px;border:1px solid rgba(255,255,255,.18);background:#fff;color:#1f1f1f;font-family:inherit;font-size:14px;font-weight:600;cursor:pointer;transition:box-shadow .18s,transform .12s;}'
    + '.aro-google:hover{box-shadow:0 8px 26px rgba(0,0,0,.4);}'
    + '.aro-google:active{transform:translateY(1px);}'
    + '.aro-google[disabled]{opacity:.6;cursor:default;}'
    + '.aro-or{display:flex;align-items:center;gap:12px;margin:18px 0;color:#5f76a6;font-size:11px;letter-spacing:.14em;}'
    + '.aro-or::before,.aro-or::after{content:"";flex:1;height:1px;background:rgba(126,162,255,.18);}'
