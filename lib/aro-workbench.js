...
(function () {
  ...
  var LIB = {
    'Equipment': [
      { t: 'pump', n: 'Centrifugal Pump', w: 64, h: 54, ports: [P(0, 34, 'w', 'in', 'Suction'), P(34, 4, 'n', 'out', 'Discharge')],
        draw: function () { return k3dBase(34, 50, 50) + '<ellipse cx="30" cy="46" rx="9" ry="10" fill="url(#wbBlue3)" stroke="#1e40af" stroke-width="1.4"/>' + '<circle cx="30" cy="30" r="19" fill="url(#wbBlue3)" stroke="#1e40af" stroke-width="1.6"/><ellipse cx="24" cy="24" rx="7" ry="4" fill="#fff" opacity="0.35"/><circle cx="30" cy="30" r="7" fill="url(#wbSteel)" stroke="#1e40af" stroke-width="1"/><path d="M30 30 L44 22 M30 30 L44 38 M30 30 L16 30" stroke="#1e40af" stroke-width="1.6" stroke-linecap="round"/><rect x="27" y="4" width="10" height="12" rx="2" fill="url(#wbBlue3)" stroke="#1e40af" stroke-width="1"/>'; } },
      { t: 'pump-ms', n: 'Multistage Pump', w: 78, h: 50, ports: [P(0, 34, 'w', 'in', 'Suction'), P(78, 34, 'e', 'out', 'Discharge')],
        draw: function () { return k3dBase(39, 48, 62) + k3dHCyl(10, 18, 58, 26, 'url(#wbBlue3)', '#1e40af') + '<circle cx="24" cy="31" r="7" fill="url(#wbSteel)" stroke="#1e40af" stroke-width="1"/><circle cx="40" cy="31" r="7" fill="url(#wbSteel)" stroke="#1e40af" stroke-width="1"/><circle cx="56" cy="31" r="7" fill="url(#wbSteel)" stroke="#1e40af" stroke-width="1"/>'; } },
      { t: 'pd-pump', n: 'PD / Gear Pump', w: 62, h: 52, ports: [P(0, 40, 'w', 'in', 'Inlet'), P(62, 40, 'e', 'out', 'Outlet')],
        draw: function () { return k3dBase(31, 48, 46) + '<circle cx="31" cy="27" r="20" fill="url(#wbSteel)" stroke="#475569" stroke-width="1.6"/><ellipse cx="24" cy="20" rx="7" ry="4" fill="#fff" opacity="0.4"/><circle cx="24" cy="27" r="8" fill="url(#wbGrey3)" stroke="#334155" stroke-width="1.2"/><circle cx="38" cy="27" r="8" fill="url(#wbGrey3)" stroke="#334155" stroke-width="1.2"/><path d="M24 19 v16 M38 19 v16 M18 27 h12 M32 27 h12" stroke="#334155" stroke-width="0.8"/>'; } },
  ...
  function render() {
    ...
    gWorld.setAttribute('transform', 'translate(' + WB.panX + ',' + WB.panY + ') scale(' + WB.zoom + ') ' + vm);
    updateCount();
  }
  ...
  function buildUI(root) {
    ...
    root.innerHTML =
      ...
      + '    <div class="wb-hint">Drag component ▸ drop · <b>drag port→port to connect</b> · select an item ▸ <b>drag the orange handle to rotate</b> · view buttons ▸ Plan/ISO/Front/Side · scroll = zoom · space-drag = pan</div>'
      + '  </div>'
  ...
  var drag = null, panning = null, spaceDown = false, connecting = false, justConnected = false, rotating = null;
