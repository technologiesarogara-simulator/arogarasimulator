...
(function () {
    ...
    function renderVizLegend(mode) {
      ...
      if (mode === 'velocity' || mode === 'pressure') {
        ...
        if (grad) {
          ...
          html += '<div class="wb-vizgradbar" style="background:' + css + '"></div>';
          html += '<div class="wb-vizgradscale"><span>' + fmtVizNum(grad.min) + '</span><span>' + fmtVizNum(grad.max) + '</span></div>';
          html += '<div class="wb-vizgradunit">' + grad.unit + '</div>';
  ...
  var WB_CSS = [
    ...
    '.wb-vizlegend{position:absolute;left:12px;bottom:44px;background:#ffffff;color:#334155;border:1px solid #cbd5e1;border-radius:8px;padding:10px 12px;font-family:var(--font-mono,monospace);font-size:11px;z-index:5;min-width:172px;box-shadow:0 4px 14px rgba(15,23,42,0.14);}',
    '.wb-vizlegend h4{margin:0 0 6px;font-size:10px;letter-spacing:0.06em;color:#64748b;font-weight:700;text-transform:uppercase;}',
    '.wb-vizlegend .wb-vizrow{display:flex;align-items:center;gap:7px;margin:3px 0;color:#334155;}',
    '.wb-vizlegend .wb-vizswatch{width:13px;height:13px;border-radius:3px;flex:none;box-shadow:inset 0 0 0 1px rgba(15,23,42,0.15);}',
    '.wb-vizlegend .wb-vizgradbar{width:100%;height:12px;border-radius:3px;box-shadow:inset 0 0 0 1px rgba(15,23,42,0.15);margin-top:2px;}',
    '.wb-vizlegend .wb-vizgradscale{display:flex;justify-content:space-between;font-size:10px;color:#334155;margin-top:3px;font-variant-numeric:tabular-nums;}',
    '.wb-vizlegend .wb-vizgradunit{text-align:center;font-size:9.5px;color:#94a3b8;margin-top:1px;}',
    '.wb-vizlegend .wb-viznote{margin-top:7px;padding-top:7px;border-top:1px solid #e2e8f0;color:#64748b;font-size:9.5px;line-height:1.45;}',
    '.wb-flowctrl{display:flex;align-items:center;gap:6px;margin-top:8px;padding-top:8px;border-top:1px solid #e2e8f0;}',
