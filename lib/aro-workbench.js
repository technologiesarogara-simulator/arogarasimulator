  ...
  var FLOWSHEETS = {
    'Crude & Distillation': {
      'Atmospheric Distillation Unit (ADU/CDU)': {
        fluid: 'Crude Oil', zoom: 0.38, panX: 60, panY: 30,
        nodes: [
          { t: 'cone-tank', tag: 'T-101 CRUDE FEED TANK',              x: 20,  y: 70,  nps: 8 },
          { t: 'pump',      tag: 'P-101A/B CRUDE CHARGE PUMPS',        x: 55,  y: 150, nps: 8 },
          { t: 'sthe',      tag: 'E-101A-C PREHEAT EXCHANGER TRAIN',   x: 120, y: 100, nps: 6 },
          { t: 'h-vessel',  tag: 'V-101 ELECTROSTATIC DESALTER',       x: 200, y: 100, nps: 6 },
          { t: 'boiler',    tag: 'H-101 CRUDE FIRED HEATER',           x: 280, y: 80,  nps: 6 },
          { t: 'column',    tag: 'C-101 ATM. DISTILLATION COLUMN',     x: 355, y: 25,  nps: 6 },
          { t: 'condenser', tag: 'E-102 OVERHEAD CONDENSER',           x: 420, y: 30,  nps: 4 },
          { t: 'h-vessel',  tag: 'V-102 REFLUX DRUM',                  x: 420, y: 90,  nps: 4 },
          { t: 'pump',      tag: 'P-102 REFLUX PUMP',                  x: 430, y: 145, nps: 4 },
          { t: 'column',    tag: 'C-102 NAPHTHA STABILIZER',           x: 490, y: 30,  nps: 4 }
        ],
        pipes: [
      ...
      'Vacuum Distillation Unit (VDU)': {
        fluid: 'Crude Oil', zoom: 0.40, panX: 60, panY: 30,
        nodes: [
          { t: 'pump',     tag: 'P-201 RESIDUE CHARGE PUMP',          x: 25,  y: 130, nps: 8 },
          { t: 'sthe',     tag: 'E-201 FEED/EFFLUENT EXCHANGER',      x: 100, y: 90,  nps: 6 },
          { t: 'boiler',   tag: 'H-201 VACUUM FURNACE',               x: 185, y: 80,  nps: 6 },
          { t: 'column',   tag: 'C-201 VACUUM DISTILLATION TOWER',    x: 270, y: 15,  nps: 6 },
          { t: 'ejector',  tag: 'EJ-201A-C STEAM EJECTOR TRAIN',      x: 350, y: 25,  nps: 4 },
          { t: 'h-vessel', tag: 'V-201 HOTWELL',                      x: 430, y: 50,  nps: 4 },
          { t: 'pump',     tag: 'P-202 VACUUM RESIDUE PUMP',          x: 290, y: 160, nps: 8 }
        ],
        pipes: [
      ...
      'Two-Stage Crude Desalting Unit': {
        fluid: 'Crude Oil', zoom: 0.38, panX: 60, panY: 30,
        nodes: [
          { t: 'pump',     tag: 'P-301 CRUDE BOOSTER PUMP',                  x: 25,  y: 120, nps: 8 },
          { t: 'sthe',     tag: 'E-301 CRUDE PREHEATER',                     x: 100, y: 65,  nps: 6 },
          { t: 'mixer',    tag: 'MX-301 FIRST-STAGE MIXER',                  x: 180, y: 100, nps: 6 },
          { t: 'h-vessel', tag: 'V-301 FIRST-STAGE ELECTROSTATIC DESALTER',  x: 255, y: 45,  nps: 6 },
          { t: 'mixer',    tag: 'MX-302 INTERSTAGE MIXER',                   x: 340, y: 100, nps: 6 },
          { t: 'h-vessel', tag: 'V-302 SECOND-STAGE ELECTROSTATIC DESALTER', x: 420, y: 45,  nps: 6 },
          { t: 'h-vessel', tag: 'V-303 BRINE DRUM',                          x: 220, y: 175, nps: 4 },
          { t: 'pump',     tag: 'P-302 BRINE PUMP',                          x: 305, y: 165, nps: 4 }
        ],
        pipes: [
