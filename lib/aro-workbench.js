...
(function () {
  ...
  /* ───────────── Refinery / petrochemical FLOWSHEET library ─────────────
     ...
     Each step is a compact recipe: 't:Label; t:Label; ...' — the loader
     instantiates the equipment left→right and wires each one's real outlet
     nozzle to the next one's real inlet nozzle as a starting P&ID the user
     edits, re-routes or extends. It reuses the same industrial equipment
     library used everywhere else in the workbench (real 3D geometry, real
     flanged pipe connections) rather than one-off custom models — a column
     currently exposes only one real 3D process outlet (overhead) alongside
     its feed inlet, so a true multi-product branching P&ID (several
     simultaneous side draws in one 3D view) needs more nozzles modelled on
     the shared equipment library first; this plant is the real crude-to-
     products path as one continuous train instead. */
  var FLOWSHEETS = {
    'AROGARA Refinery Plant': {
      'Crude to Products — Full Process Train': 'cone-tank:Crude Storage Tank TK-101; pump:Crude Charge Pump P-101; sthe:Crude Preheat Train E-101; mixer:Wash Water Mixer MX-101; h-vessel:1st Stage Desalter V-101; pump:Interstage Pump P-102; h-vessel:2nd Stage Desalter V-102; boiler:Crude Furnace F-101; column:Atmospheric Column C-101; aircooler:ADU OVHD Condenser E-102; v-vessel:ADU Reflux Drum V-103; pump:ADU Reflux Pump P-103; boiler:Vacuum Furnace F-201; column:Vacuum Column C-201; ejector:1st Stage Ejector EJ-201; ejector:2nd Stage Ejector EJ-202; ejector:3rd Stage Ejector EJ-203; vacuum-vessel:Hotwell V-201; pump:VGO Pump P-201; boiler:FCC Feed Preheater F-401; fbr:FCC Riser Reactor R-401; cyclone:Disengager/Cyclones V-401; v-vessel:Catalyst Regenerator RG-401; blower:Regenerator Air Blower B-401; column:FCC Main Fractionator C-401; aircooler:FCC OVHD Condenser E-401; v-vessel:FCC Reflux Drum V-402; recip-comp:Wet Gas Compressor K-401; separator:High Pressure Separator D-401; column:Gas Concentration Column C-402; absorber:Amine Absorber C-403; column:Amine Regenerator C-404; boiler:Sulfur Reaction Furnace F-501; sthe:Waste Heat Boiler E-501; v-vessel:Sulfur Pit V-501; column:Naphtha Stabilizer C-601; pbr:Reformer Reactor R-601; pbr:Isomerization Reactor R-602; cone-tank:Products Storage Tank TK-901'
    }
  };
