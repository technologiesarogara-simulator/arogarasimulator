...
(function () {
  ...
  WB.report = function () {
    ...
    var tables = '<h4>Equipment Technical Data Sheet</h4><table class="wb-table"><tr><th>#</th><th>Tag</th><th>Name</th><th>Type</th><th>Location</th><th>Fluid</th><th>Flow m³/h</th><th>T °C</th><th>P barg</th></tr>' + (eq || '<tr><td colspan="9">No equipment placed.</td></tr>') + '</table>'
      + '<h4>Line List &amp; Hydraulics</h4><table class="wb-table"><tr><th>#</th><th>Line</th><th>Fluid</th><th>NPS (line size)</th><th>Flow</th><th>Velocity m/s</th><th>Re</th><th>ΔP bar</th><th>Status</th></tr>' + (pr || '<tr><td colspan="9">No lines drawn.</td></tr>') + '</table>';
    ...
    capture3D(function (img3d) {
      ...
      var views = '<h4>2D Flowsheet View</h4>' + (img2d ? '<div class="wb-rep-view">' + '<img src="' + img2d + '" alt="2D flowsheet" style="' + imgStyle + '"/></div>' : '<div class="wb-rep-note">2D view unavailable.</div>')
      ...
      var html = '<div class="wb-rep-head">ARO WORKBENCH — PROCESS SYSTEM REPORT</div>'
        + '<div class="wb-rep-sub">AROGARA FlowSize · ' + new Date().toLocaleString() + '</div>'
        + verdict + views + tables;
  ...
  function wireUI(root) {
    ...
    if (lineCol) {
      // reflect the selected 3D line's colour + size into the controls
