...
(function () {
  ...
  /* ───────────── Refinery / petrochemical FLOWSHEET library ─────────────
     5 flowsheets matching the AROGARA "First 5 Industrial 3D Flowsheets"
     conceptual set (Rev B). Each is a compact recipe: 't:Label; t:Label; ...'
     — the loader instantiates the equipment left→right and wires them in
     series as a starting P&ID the user edits. Reuses the industrial symbols
     already in the palette. */
  var FLOWSHEETS = {
    'AROGARA Conceptual Flowsheets (Rev B)': {
      'Crude Distillation Unit (CDU/ADU)': 'sthe:Crude Preheat Train E-101; pump:Charge Pump P-101; h-vessel:Desalter Drum V-101; boiler:Crude Furnace F-101; column:Atmospheric Column C-101; stripper:Kerosene Side Stripper C-102; stripper:Diesel Side Stripper C-103; aircooler:OVHD Condenser E-102; v-vessel:Reflux Drum V-102; pump:Reflux Pump P-102; sthe:Product Cooler E-103; pump:Rundown Pump P-103',
      'Vacuum Distillation Unit (VDU)': 'sthe:Feed Preheat E-201; boiler:Vacuum Furnace F-201; column:Vacuum Column C-201; ejector:1st Stage Ejector EJ-201; ejector:2nd Stage Ejector EJ-202; ejector:3rd Stage Ejector EJ-203; vacuum-vessel:Hotwell V-201; pump:VGO Pump P-201; pump:Slop Wax Pump P-202; sthe:VGO Cooler E-202',
      'Two-Stage Crude-Oil Desalting System': 'sthe:Crude Preheat E-301; pump:Crude Charge Pump P-301; mixer:Wash Water Mixer MX-301; h-vessel:1st Stage Desalter V-301; pump:Interstage Pump P-302; mixer:Wash Water Mixer MX-302; h-vessel:2nd Stage Desalter V-302; pump:Brine Effluent Pump P-303; v-vessel:Effluent Water Drum V-303; sthe:Desalted Crude Cooler E-302',
      'Fluid Catalytic Cracking Unit (FCCU)': 'boiler:Feed Preheater F-401; fbr:Riser Reactor R-401; cyclone:Disengager/Cyclones V-401; v-vessel:Catalyst Regenerator RG-401; blower:Air Blower B-401; column:Main Fractionator C-401; aircooler:OVHD Condenser E-401; v-vessel:Reflux Drum V-402; recip-comp:Wet Gas Compressor K-401; separator:HP Separator D-401; column:Gas Concentration Column C-402',
      'Propane Deasphalting Unit (PDA)': 'sthe:Feed Preheat E-501; extraction-col:Propane Extraction Tower C-501; recip-comp:Propane Compressor K-501; accumulator:Propane Accumulator V-501; stripper:DAO Stripper C-502; stripper:Asphalt Stripper C-503; flash-drum:Asphalt Flash Drum V-502; sthe:Solvent Recovery HX E-502; pump:DAO Pump P-501; pump:Asphalt Pump P-502'
    }
  };
  ...
  function buildUI(root) {
    ...
    root.innerHTML =
      ...
      + '  <div class="wb-menu"><button>Flowsheets ▾</button><div class="wb-drop"><a data-a="flowsheets">📋 Refinery Flowsheet Library (5 units)…</a></div></div>'
