...
(function () {
  ...
  function mount(id) {
    ...
    wrap.innerHTML =
      ...
      + '<span class="aro3di-sp"></span>'
      + '<button type="button" class="aro3di-btn" data-a="zoomin" title="Zoom in — Ctrl/⌘+scroll does the same">ZOOM +</button>'
      + '<button type="button" class="aro3di-btn" data-a="zoomout" title="Zoom out — Ctrl/⌘+scroll does the same">ZOOM &minus;</button>'
  ...
  /* Button-driven zoom, for engineers who never discover Ctrl/⌘+scroll (a
     plain scroll had to pass through untouched to the page — see
     CustomOrbitControls' own wheel handler — so a keyboard-and-mouse-only
     way to zoom needed its own control, not a substitute for the gesture). */
