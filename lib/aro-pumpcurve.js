/* ══════════════════════════════════════════════════════════════════════
   ...
   say where on a pump that duty sat. This models the machine:
     ...
     · head, efficiency, NPSHr and power against flow as dimensionless
       ...
       specific speed as API 610 §6.1.11 expects it to be checked;
...
(function () {
  ...
  /* ── shut-off head rise ──────────────────────────────────────────────
     API 610 §6.1.11 wants a curve that rises continuously to shut-off,
  ...
  /* API 610 §6.1.11 preferred and allowable operating regions. */
