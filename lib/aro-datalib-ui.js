...
(function () {
  ...
  function css() {
    ...
    s.textContent = [
      ...
      '  letter-spacing:.1em;color:#38bdf8;white-space:nowrap;}',
      '.dl-search{flex:1;max-width:480px;display:flex;align-items:center;gap:7px;background:#0b1220;',
      ...
      '.dl-tabs{display:flex;gap:2px;padding:0 16px;background:#0f172a;border-bottom:1px solid #1e293b;',
      ...
      '.dl-grip{cursor:col-resize;background:#1e293b;}',
      '.dl-grip:hover{background:#38bdf8;}',
      ...
      '  cursor:pointer;font-size:11.5px;color:#cbd5e1;gap:8px;}',
      ...
      '.dl-domh{display:flex;align-items:center;gap:9px;padding:7px 9px;border:1px solid #1e293b;',
      '  border-radius:5px;margin-top:6px;cursor:pointer;background:#0f172a;}',
      '.dl-domh:hover{border-color:#38bdf8;}',
      '.dl-domh b{font-size:11px;color:#e2e8f0;flex:1;}',
      '.dl-domh .cnt{font-family:var(--font-mono,monospace);font-size:9px;color:#64748b;}',
      '.dl-bar{width:74px;height:4px;border-radius:2px;background:#1e293b;overflow:hidden;flex:none;}',
      '.dl-bar i{display:block;height:100%;background:#38bdf8;}',
      ...
      '  position:sticky;top:-12px;background:#0b1220;z-index:2;}',
      '.dl-pt td{padding:6px 8px;border-bottom:1px solid #16202f;}',
      '.dl-pt tr.pr{cursor:pointer;}',
      '.dl-pt tr.pr:hover td{background:rgba(56,189,248,.06);}',
      ...
      '.dl-act{background:none;border:1px solid #334155;color:#64748b;border-radius:3px;',
      '  font-family:var(--font-mono,monospace);font-size:8.5px;padding:2px 6px;cursor:pointer;margin-right:4px;}',
      '.dl-act:hover{border-color:#38bdf8;color:#38bdf8;}',
      ...
      '.dl-kv span:nth-child(even){color:#cbd5e1;word-break:break-word;}',
      ...
      '  border:1px solid #334155;background:transparent;color:#94a3b8;cursor:pointer;margin:0 5px 5px 0;}',
      '.dl-chip.on{background:#38bdf8;border-color:#38bdf8;color:#04121e;font-weight:800;}',
      '.dl-counts{font-family:var(--font-mono,monospace);font-size:10px;color:#94a3b8;',
      '  letter-spacing:.04em;margin:2px 0 8px;}',
      '.dl-counts b{color:#f1f5f9;}',
      '.dl-counts i{font-style:normal;color:#38bdf8;}',
      ...
      '  padding:5px 0;border-bottom:1px solid #16202f;align-items:baseline;}',
      '.dl-lin b{font-family:var(--font-mono,monospace);font-size:9px;letter-spacing:.05em;color:#64748b;}',
      '.dl-lin i{font-style:normal;font-family:var(--font-mono,monospace);font-size:8.5px;}',
      '.dl-lin.act{background:rgba(56,189,248,.08);}',
      '.dl-lin.act b{color:#38bdf8;}'
    ].join('');
