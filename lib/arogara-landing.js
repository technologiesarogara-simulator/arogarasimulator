...
(function () {
  ...
  var WORKFLOW = [
    ...
    { ic: 'cube', t: '3D model',            d: 'Live, and updated as you type.' },
  ...
  function html() {
    return css()
      ...
      + '  <div class="al-heroVid"><video autoplay muted loop playsinline preload="metadata" poster="" aria-label="AROGARA FlowSize — 20 second overview">'
      +      '<source src="assets/video/arogara-flowsize-promo-20s.mp4" type="video/mp4"></video></div>'
      + '</header>'
      ...
      + '      <p>AROGARA FlowSize — process engineering, reimagined. A single cloud workbench for sizing, visualising and documenting plant equipment.</p></div>'
