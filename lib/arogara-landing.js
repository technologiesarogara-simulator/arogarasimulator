...
(function () {
  ...
  function css() {
    return '<style id="aro-land-css">'
      ...
      + '.al-notecard{margin-top:22px;border:1px solid rgba(126,162,255,.22);border-radius:8px;'
      +   'background:rgba(12,20,38,.55);padding:18px 20px;}'
      + '.al-notecard h4{margin:0 0 10px;font-size:13.5px;letter-spacing:.02em;color:#dbe6ff;}'
      + '.al-notecard ul{margin:0;padding-left:18px;}'
      + '.al-notecard li{margin:6px 0;font-size:13px;line-height:1.6;color:#b7c8ea;}'
      + '.al-notecard li b,.al-fine b{color:#dbe6ff;}'
      + '.al-fine{margin:12px 0 0;font-size:12.5px;line-height:1.65;color:#93a6cc;}'
  ...
  function html() {
    return css()
      ...
      +      ['ROTATE', 'ZOOM', 'PAN', 'FIT MODEL', 'ISO / FRONT / BACK / LEFT / RIGHT / TOP / BOTTOM',
              'ORTHOGRAPHIC ELEVATIONS', 'INSPECT COMPONENT', 'FLOW', 'VELOCITY', 'PRESSURE',
              'BILL OF MATERIAL', 'ISOMETRIC', 'SNAPSHOT',
              'SIMPLE / INDUSTRIAL / ENGINEERING / ANALYTICAL']
