...
(function () {
  ...
  function html() {
    return css()
      ...
      + '    <div class="al-vm">'
      + '      <div class="al-vmc"><span class="ic">🌏</span><h3>Our Vision</h3><p>To make world-class process-engineering design accessible to every Indian engineer — replacing scattered spreadsheets and costly desktop tools with a single, intuitive, cloud workbench that turns rigorous calculation into a delightful experience.</p></div>'
