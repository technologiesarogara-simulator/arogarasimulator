...
(function () {
  ...
  function css() {
    return '<style id="aro-land-css">'
      ...
      + '.al-step{background:#fbfcfe;border:1px solid rgba(15,23,42,.08);'
      ...
      + '.al-step h4{margin:0 0 6px;font-size:12px;letter-spacing:.09em;color:#111a30;font-weight:700;}'
      + '.al-step p{margin:0;font-size:12.5px;line-height:1.55;color:#5b6b8c;}'
      ...
      + '.al-audit{margin-top:24px;max-width:620px;border:1px solid rgba(15,23,42,.1);border-radius:8px;'
      ...
      +   'border-bottom:1px solid rgba(15,23,42,.07);font-family:ui-monospace,monospace;font-size:11px;}'
      + '.al-auditrow:last-child{border-bottom:none;}'
      + '.al-auditk{color:#47547a;letter-spacing:.07em;}'
      + '.al-auditv{font-weight:800;letter-spacing:.08em;}'
      + '.al-auditv.ok{color:#16a34a;}.al-auditv.warn{color:#c2790a;}.al-auditv.bad{color:#dc2626;}'
      + '.al-auditsum{margin-top:12px;font-family:ui-monospace,monospace;font-size:11.5px;font-weight:800;'
      +   'letter-spacing:.07em;color:#243878;}'
      + '.al-dim{color:#7381a3;font-weight:400;letter-spacing:.04em;}'
      ...
      + '.al-traceA{color:#8090b3;font-size:14px;}'
