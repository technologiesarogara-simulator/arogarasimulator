...
(function () {
  ...
  function css() {
    return '<style id="aro-land-css">'
      ...
      + '#aro-landing :focus-visible{outline:2px solid #ff7538;outline-offset:3px;border-radius:8px;}'
      + '.al-bg{position:fixed;inset:0;overflow:hidden;pointer-events:none;z-index:0;}'
      + '.al-orb{position:absolute;border-radius:50%;filter:blur(90px);opacity:.14;animation:alFloat 16s ease-in-out infinite;}'
      + '.al-grid{position:absolute;inset:0;background-image:linear-gradient(rgba(15,23,42,.045) 1px,transparent 1px),linear-gradient(90deg,rgba(15,23,42,.045) 1px,transparent 1px);background-size:44px 44px;mask-image:radial-gradient(ellipse at 50% 0%,#000 40%,transparent 78%);}'
      ...
      + '.al-brand img{width:36px;height:36px;border-radius:11px;box-shadow:0 6px 22px rgba(255,117,56,.28);}'
      ...
      + '.al-navlinks a:hover{color:#111a30;border-bottom-color:#ff7538;}'
      ...
      + '.al-btn-primary{background:linear-gradient(135deg,#ff7538,#ff9d4d);color:#231000;padding:11px 22px;font-size:14px;box-shadow:0 10px 26px rgba(255,117,56,.28);}'
      + '.al-btn-primary:hover{box-shadow:0 14px 36px rgba(255,117,56,.4);}'
      + '.al-btn-ghost{background:rgba(15,23,42,.04);border:1px solid rgba(15,23,42,.14);color:#1c2540;padding:11px 22px;font-size:14px;}'
      + '.al-btn-ghost:hover{background:rgba(15,23,42,.08);}'

      + '.al-hero{text-align:center;padding:70px 24px 26px;position:relative;z-index:1;max-width:920px;margin:0 auto;}'
      + '.al-pill{display:inline-flex;align-items:center;gap:8px;padding:6px 14px;border:1px solid rgba(15,23,42,.12);border-radius:999px;background:#f6f8fc;font-size:12px;color:#5b6b8c;letter-spacing:.04em;margin-bottom:22px;}'
      + '.al-pill .dot{width:7px;height:7px;border-radius:50%;background:#22c55e;box-shadow:0 0 10px #22c55e;}'
      + '.al-hero h1{font-size:clamp(32px,5.6vw,56px);line-height:1.09;font-weight:700;color:#111a30;margin:0 0 20px;letter-spacing:-.015em;}'
      + '.al-hero h1 .g{background:linear-gradient(90deg,#ff7538,#3452c8 75%);-webkit-background-clip:text;background-clip:text;color:transparent;}'
      ...
      + '.al-eyebrow{text-align:center;font-size:11.5px;letter-spacing:.22em;text-transform:uppercase;color:#ff7538;font-weight:700;margin-bottom:12px;}'
      ...
      /* One card surface for the whole page, so every block reads as a set —
         a soft shadow does the work a dark translucent fill used to, now
         that the ground beneath every card is plain white. */
      + '.al-card{border:1px solid rgba(15,23,42,.09);border-radius:18px;background:#ffffff;box-shadow:0 1px 2px rgba(15,23,42,.04);transition:transform .18s,border-color .18s,box-shadow .18s;}'
      + '.al-card:hover{transform:translateY(-3px);border-color:rgba(255,117,56,.4);box-shadow:0 14px 30px rgba(15,23,42,.08);}'
      ...
      + '.al-fig::before{content:"";position:absolute;top:0;left:22%;right:22%;height:2px;border-radius:2px;background:linear-gradient(90deg,#ff7538,#3452c8);opacity:.75;}'
      + '.al-fig .n{font-size:clamp(20px,2.4vw,28px);font-weight:700;color:#111a30;line-height:1.1;letter-spacing:-.01em;}'
      ...
      + '.al-vmc{border:1px solid rgba(15,23,42,.09);border-radius:20px;padding:30px;background:linear-gradient(160deg,#fff8f4,#f4f7ff);position:relative;overflow:hidden;}'
      + '.al-vmc::before{content:"";position:absolute;top:0;left:0;right:0;height:2px;background:linear-gradient(90deg,#ff7538,#3452c8);}'
      + '.al-vmc .ic{display:inline-flex;align-items:center;justify-content:center;width:44px;height:44px;border-radius:12px;color:#ff7538;background:linear-gradient(135deg,rgba(255,117,56,.14),rgba(52,82,200,.12));border:1px solid rgba(15,23,42,.08);margin-bottom:14px;}'
      ...
      + '.al-mod .mi{width:44px;height:44px;border-radius:12px;display:flex;align-items:center;justify-content:center;color:#ff7538;background:linear-gradient(135deg,rgba(255,117,56,.16),rgba(52,82,200,.14));border:1px solid rgba(15,23,42,.08);margin-bottom:14px;}'
      ...
      + '.al-step .si{display:flex;align-items:center;color:#3452c8;margin-bottom:9px;}'
      ...
      + '.al-ind{display:inline-flex;align-items:center;gap:9px;padding:9px 16px;border-radius:999px;border:1px solid rgba(15,23,42,.1);background:#ffffff;font-size:13.5px;color:#33436b;transition:border-color .16s,box-shadow .16s,transform .16s;}'
      + '.al-ind:hover{border-color:rgba(255,117,56,.45);box-shadow:0 6px 16px rgba(15,23,42,.07);transform:translateY(-2px);}'
      + '.al-ind .aro-ic{color:#3452c8;flex:none;}'
      + '.al-ind:hover .aro-ic{color:#ff7538;}'
      ...
      + '.al-libitem .li{display:flex;align-items:center;flex:none;color:#3452c8;margin-top:1px;}'
      ...
      + '.al-ask{display:flex;gap:10px;align-items:center;padding:13px 16px;border-radius:13px;border:1px solid rgba(15,23,42,.09);background:#f8f9fd;font-size:14px;color:#1c2540;}'
      + '.al-ask .q{color:#ff7538;font-weight:700;flex:none;}'
      ...
      + '.al-whoitem .wi{display:flex;align-items:center;justify-content:center;color:#ff7538;margin-bottom:8px;}'
      ...
      + '.al-roaditem{padding:14px 16px;display:flex;align-items:center;gap:10px;border:1px dashed rgba(15,23,42,.18);border-radius:14px;background:#f8f9fd;}'
      + '.al-roaditem .rd{width:7px;height:7px;border-radius:50%;background:#ff7538;flex:none;box-shadow:0 0 9px rgba(255,117,56,.5);}'
      + '.al-roaditem b{font-size:13.5px;color:#33436b;font-weight:600;}'

      + '.al-band{margin:20px auto 0;border-radius:24px;padding:48px 32px;text-align:center;background:linear-gradient(135deg,rgba(255,117,56,.1),rgba(52,82,200,.1));border:1px solid rgba(15,23,42,.08);}'
      ...
      + '.al-footcol h5{font-size:11px;letter-spacing:.16em;text-transform:uppercase;color:#ff7538;margin:0 0 12px;font-weight:700;}'
      ...
      +   'font-weight:700;letter-spacing:.09em;color:#243878;background:rgba(52,82,200,.1);'
      +   'border:1px solid rgba(52,82,200,.3);border-radius:5px;padding:8px 16px;}'
      ...
      +   'letter-spacing:.08em;color:#b24d10;background:rgba(255,117,56,.09);'
      +   'border:1px solid rgba(255,117,56,.32);border-radius:5px;padding:7px 12px;}'
      ...
      + '.al-wfstep{background:#fbfcfe;border:1px solid rgba(15,23,42,.08);'
      +   'border-top:2px solid rgba(255,117,56,.55);border-radius:8px;padding:16px 14px;}'
      + '.al-stepn{font-family:ui-monospace,monospace;font-size:20px;font-weight:800;color:#ff7538;'
      ...
      + '.al-igitem .ii{display:inline-flex;align-items:center;justify-content:center;width:46px;height:46px;border-radius:13px;color:#ff7538;background:linear-gradient(135deg,rgba(255,117,56,.14),rgba(52,82,200,.12));border:1px solid rgba(15,23,42,.08);margin-bottom:12px;}'
      ...
      + '.al-tric{background:#fbfcfe;border:1px solid rgba(15,23,42,.09);'
      ...
      + '.al-traceseg{position:relative;width:26px;height:2px;background:linear-gradient(90deg,#3452c8,#7ea2ff);flex:none;margin:0 2px;}'
      + '.al-traceseg::after{content:"";position:absolute;right:-1px;top:50%;transform:translateY(-50%);width:0;height:0;'
      +   'border-top:4px solid transparent;border-bottom:4px solid transparent;border-left:6px solid #3452c8;}'
