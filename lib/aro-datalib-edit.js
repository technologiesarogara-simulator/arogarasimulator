...
(function () {
  ...
  function css() {
    ...
    s.id = CSSID;
    s.textContent = [
      '.de-back{position:fixed;inset:0;z-index:99995;background:rgba(2,6,16,.72);',
      '  display:flex;align-items:flex-start;justify-content:center;padding:36px 16px;overflow:auto;}',
      '.de-box{background:#0f172a;color:#e2e8f0;border:1px solid #1e293b;border-radius:9px;',
      '  width:100%;max-width:760px;box-shadow:0 24px 70px rgba(0,0,0,.6);',
      '  font-family:var(--font-sans,system-ui,sans-serif);}',
      '.de-box.wide{max-width:1080px;}',
      '.de-box *{box-sizing:border-box;}',
      '.de-h{padding:13px 17px;border-bottom:1px solid #1e293b;display:flex;align-items:center;gap:10px;}',
      '.de-h b{font-family:var(--font-mono,ui-monospace,monospace);font-size:12px;letter-spacing:.08em;color:#38bdf8;}',
      '.de-h small{color:#64748b;font-size:10.5px;margin-left:auto;}',
      '.de-b{padding:15px 17px;max-height:70vh;overflow:auto;}',
      '.de-f{padding:11px 17px;border-top:1px solid #1e293b;display:flex;gap:7px;justify-content:flex-end;flex-wrap:wrap;}',
      '.de-sec{font-family:var(--font-mono,monospace);font-size:9px;letter-spacing:.11em;color:#475569;',
      '  margin:15px 0 7px;text-transform:uppercase;border-top:1px solid #16202f;padding-top:11px;}',
      ...
      '.de-fld label{font-family:var(--font-mono,monospace);font-size:9px;letter-spacing:.06em;color:#64748b;}',
      '.de-fld input,.de-fld select,.de-fld textarea{background:#0b1220;border:1px solid #1e293b;',
      '  border-radius:4px;color:#e2e8f0;padding:7px 8px;font-size:12px;outline:none;width:100%;',
      '  font-family:var(--font-sans,system-ui,sans-serif);}',
      '.de-fld textarea{font-family:var(--font-mono,ui-monospace,monospace);font-size:11px;min-height:96px;resize:vertical;}',
      '.de-fld input:focus,.de-fld select:focus,.de-fld textarea:focus{border-color:#38bdf8;}',
      '.de-fld.req label:after{content:" ·  required";color:#fbbf24;}',
      '.de-hint{font-size:10.5px;color:#94a3b8;line-height:1.6;margin-top:5px;}',
      '.de-warn{font-size:10.5px;line-height:1.6;color:#fbbf24;border-left:2px solid #fbbf24;',
      '  padding-left:9px;margin-top:10px;}',
      '.de-note{font-size:10.5px;line-height:1.6;color:#93c5fd;border-left:2px solid #38bdf8;',
      '  padding-left:9px;margin-top:10px;}',
      ...
      '  padding:8px 13px;border-radius:4px;cursor:pointer;border:1px solid #334155;',
      '  background:transparent;color:#cbd5e1;}',
      '.de-btn:hover{border-color:#38bdf8;color:#38bdf8;}',
      '.de-btn.go{background:#38bdf8;border-color:#38bdf8;color:#04121e;}',
      '.de-btn.danger{border-color:#7f1d1d;color:#fca5a5;}',
      '.de-btn:disabled{opacity:.4;cursor:not-allowed;}',
      '.de-live{font-family:var(--font-mono,monospace);font-size:10.5px;color:#cbd5e1;',
      '  background:#0b1220;border:1px solid #1e293b;border-radius:5px;padding:9px 11px;margin-top:11px;',
      '  line-height:1.75;}',
      '.de-live b{color:#f1f5f9;}',
      ...
      '  color:#475569;padding:6px 8px;border-bottom:1px solid #1e293b;position:sticky;top:0;background:#0f172a;}',
      '.de-t td{padding:6px 8px;border-bottom:1px solid #16202f;vertical-align:top;}',
      ...
      '  align-items:center;padding:7px 0;border-bottom:1px solid #16202f;font-size:11.5px;}',
      '.de-pair span.ar{color:#38bdf8;text-align:center;font-family:var(--font-mono,monospace);}',
      '.de-lin{display:grid;grid-template-columns:150px 96px minmax(0,1fr);gap:6px 10px;font-size:10.5px;',
      '  padding:6px 0;border-bottom:1px solid #16202f;align-items:baseline;}',
      '.de-lin b{font-family:var(--font-mono,monospace);font-size:9.5px;letter-spacing:.05em;color:#64748b;}',
      '.de-lin i{font-style:normal;font-family:var(--font-mono,monospace);font-size:9px;}',
      '.de-lin.act{background:rgba(56,189,248,.08);}',
      '.de-lin.act b{color:#38bdf8;}',
      '.de-chip{display:inline-block;font-family:var(--font-mono,monospace);font-size:9px;padding:3px 7px;',
      '  border-radius:3px;border:1px solid #334155;color:#94a3b8;margin:0 4px 4px 0;cursor:pointer;}',
      '.de-chip.on{background:#38bdf8;border-color:#38bdf8;color:#04121e;font-weight:800;}'
    ].join('');
