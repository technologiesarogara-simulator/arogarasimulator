...
(function () {
  ...
  function wire() {
    ...
    // orbit controls (real spherical camera)
    var down = null;
    ...
    addEquipment('sthe'); addEquipment('centrifugal-pump');
  }
  function onResize() {
    if (!renderer) return; var c = document.getElementById('a3-canvas'); if (!c) return;
