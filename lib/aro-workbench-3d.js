...
(function () {
  ...
  var routeLine = null;
  function clearRouteLine() { if (routeLine) { scene.remove(routeLine); if (routeLine.geometry) routeLine.geometry.dispose(); if (routeLine.material) routeLine.material.dispose(); routeLine = null; } }
  function updateRouteLine() {
    ...
    var mat = new THREE.LineDashedMaterial({ color: 0x2563eb, dashSize: 0.5, gapSize: 0.35, linewidth: 2, transparent: true, opacity: 0.85 });
