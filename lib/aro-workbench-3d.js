...
(function () {
  ...
  var FAC = {
    ...
    'v-vessel': function () {
      ...
      g.userData.portDefs = [
        { role: 'out', name: 'Liquid Outlet', local: new THREE.Vector3(0, 2 - 1.2, 0), dir: new THREE.Vector3(0, -1, 0) },
        { role: 'in', name: 'Feed Inlet', local: new THREE.Vector3(0, 2 + H + R + 0.6, 0), dir: new THREE.Vector3(0, 1, 0) }
      ];
      return g;
    },
    'h-vessel': function () {
    ...
    'compressor': function () {
      ...
      g.userData.portDefs = [
        { role: 'in', name: 'Suction', local: new THREE.Vector3(-1, 2 + 1.5 + 0.6, 0), dir: new THREE.Vector3(0, 1, 0) },
