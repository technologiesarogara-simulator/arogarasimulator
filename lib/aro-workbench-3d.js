...
(function () {
  ...
  function buildFlowTubeFor(grp) {
    ...
    // Thicker strands (0.4 → 0.6 of offR) read as an actual body of fluid
    // filling most of the bore rather than thin wires threaded through it.
    ...
    for (var s = 0; s < strands; s++) {
      ...
      var tube = new THREE.TubeGeometry(strandCurve, segs, Math.max(0.025, offR * 0.6), 8, false);
