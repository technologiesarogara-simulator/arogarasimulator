...
(function () {
  ...
  var FAC = {
    'centrifugal-pump': function () {
      ...
      var g = new THREE.Group();
      var castIron = new THREE.MeshStandardMaterial({ color: 0x4b4f52, metalness: 0.55, roughness: 0.55, envMapIntensity: ENV_MAP_INTENSITY });
      var safetyYellow = new THREE.MeshStandardMaterial({ color: 0xf4c430, metalness: 0.05, roughness: 0.55, envMapIntensity: ENV_MAP_INTENSITY });
      // volute casing — cast iron, not painted blue
      var vol = cyl(1.5, 1.5, 1.1, castIron); vol.rotation.x = Math.PI / 2; vol.position.set(-2.3, 1.4, 0); g.add(vol);
      ...
      // not a perfect drum
      var lobe = cyl(1.5, 1.5, 1.1, castIron); lobe.rotation.x = Math.PI / 2; lobe.scale.set(1.18, 1, 0.55); lobe.position.set(-2.3, 1.15, -0.6); g.add(lobe);
      ...
      var suc = cyl(0.55, 0.55, 1.0, castIron); suc.rotation.x = Math.PI / 2; suc.position.set(-2.3, 1.4, 1.2); g.add(suc);
      g.add(flgZ(-2.3, 1.4, 1.7, 0.75));
      var dis = cyl(0.5, 0.5, 1.3, castIron); dis.position.set(-2.3, 2.6, 0); g.add(dis);
      g.add(nozzleY(3.2, 0.0, 0.5, castIron, -2.3));
      ...
      var guard = box(0.95, 1.15, 1.35, safetyYellow); guard.position.set(-0.85, 1.4, 0); g.add(guard);
