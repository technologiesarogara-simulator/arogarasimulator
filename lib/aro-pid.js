...
(function () {
  ...
  function legs(overrideNps, overrideSch) {
    ...
    return DOC.segs.map(function (s, i) {
      ...
      return { seg: s, idx: i + 1, rho: rho, nps: nps, sch: sch, Dmm: b.Dmm, D: b.D, L: L, dz: dz,
  ...
  function panelHTML() {
    ...
    h += '<canvas id="pid-canvas" width="1180" height="430" style="width:100%;background:#0b1220;border:1px solid var(--border-muted);border-radius:6px;cursor:crosshair;display:block;"></canvas>';
