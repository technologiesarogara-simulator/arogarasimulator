...
(function () {
  ...
  function kOf(key, nps, it) {
    var c = lib(key);
    if (key === 'red' && it && it.d1 && it.d2) return redK(it);
  ...
  function applyReducers() {
    ...
    var reds = DOC.items.filter(function (it) { return it.key === 'red' && it.d1 && it.d2; })
  ...
  function render() {
    ...
    if (ub) ub.addEventListener('click', function () {
      ...
      DOC.items.forEach(function (it) { if (it.key === 'red') { it.d1 = r.uniform.nps; it.d2 = stepNps(r.uniform.nps, -1); it.sch = r.uniform.sch; } });
      applyReducers();
      render();
    });
  ...
  function syncSelPanel() {
    ...
    if (SEL.kind === 'seg') {
      ...
      $('pid-selred').style.display = (it.key === 'red') ? 'block' : 'none';
      if (it.key === 'red') {
  ...
  function wire() {
    ...
    $('pid-applyall').addEventListener('click', function () {
      ...
      DOC.items.forEach(function (it) { if (it.key === 'red') { it.d1 = n; it.d2 = stepNps(n, -1); it.sch = c; } });
