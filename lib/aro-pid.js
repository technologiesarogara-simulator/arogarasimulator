...
(function () {
  ...
  var PAN3D = false;                                         // 3D toolbar toggle: drag moves the view instead of orbiting it
  ...
  function init3D() {
    ...
    window.addEventListener('mousemove', function (e) {
      if (!down) return;
      if (PAN3D) {
        /* MOVE VIEW: shift the orbit target instead of rotating around it.
  ...
  function panelHTML() {
    ...
    h += '<div style="display:flex;flex-wrap:wrap;gap:4px;align-items:center;margin-bottom:6px;">'
      ...
      + '<button id="pid-pan3d" class="pid-act" style="display:none;">✋ MOVE VIEW: OFF</button>'
      + '<span style="width:8px;"></span>'
  ...
  function setView3D(on) {
    ...
    var b2 = $('pid-v2d'), b3 = $('pid-v3d'), bc = $('pid-colmode'), bf = $('pid-flowvis'), bp = $('pid-pan3d');
  ...
  function tagText(r) {
    ...
    return r.legs.length + ' legs · ' + f2(r.tot.L) + ' m · ' + DOC.items.length + ' components · '
      ...
      + (PAN3D ? ' · drag to move the view, scroll to zoom (MOVE VIEW is on)' : ' · drag to rotate, scroll to zoom — toggle MOVE VIEW to pan instead');
  }
  ...
  function wire() {
    ...
    $('pid-pan3d').addEventListener('click', function () {
      PAN3D = !PAN3D;
      $('pid-pan3d').textContent = '✋ MOVE VIEW: ' + (PAN3D ? 'ON' : 'OFF');
      var c3 = $('pid-3d'); if (c3) c3.style.cursor = PAN3D ? 'move' : 'grab';
    });
