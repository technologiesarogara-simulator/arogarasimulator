...
(function () {
  ...
  function report() {
    ...
    var h = '<div style="font-family:Arial,sans-serif;color:#111827;">'
      + '<h2 style="text-align:center;color:#ea580c;margin:0;">AROGARA — P&amp;ID LINE HYDRAULICS REPORT</h2>'
      + '<div style="text-align:center;font-size:10px;color:#6b7280;">AROGARA · Digital Engineering Design Platform</div>'
