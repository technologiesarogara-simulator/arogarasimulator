...
(function () {
  ...
  function panelHTML() {
    ...
    h += '<div style="flex:1;min-width:0;position:relative;">'
      + '<canvas id="pid-canvas" width="1180" height="' + CANVAS_H + '" style="width:100%;height:' + CANVAS_H + 'px;background:#0b1220;border:1px solid var(--border-muted);border-radius:6px;cursor:crosshair;display:block;"></canvas>'
      + '<canvas id="pid-3d" style="width:100%;height:' + CANVAS_H + 'px;background:#0b1220;border:1px solid var(--border-muted);border-radius:6px;display:none;cursor:grab;"></canvas>'
