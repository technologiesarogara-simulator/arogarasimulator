...
(function () {
  ...
  function panelHTML() {
    ...
    h += '<div style="width:228px;flex:none;height:' + CANVAS_H + 'px;display:flex;flex-direction:column;border:1px solid var(--border-muted);border-radius:6px;background:rgba(2,6,18,0.35);overflow:hidden;">'
    ...
    h += '<div id="pid-selbox" style="display:none;margin-top:8px;border:1px solid var(--color-saffron);border-radius:5px;padding:8px;background:rgba(255,117,56,0.06);">'
      ...
      + '<select id="pid-sel-ltype" style="width:100%;margin-top:2px;background:rgba(2,6,18,0.6);border:1px solid var(--border-muted);color:#e2e8f0;font-family:var(--font-mono);font-size:11px;padding:5px 7px;border-radius:3px;"><optgroup label="Process Piping">'
