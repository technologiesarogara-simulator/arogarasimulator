...
(function () {
  ...
  function viewportRestoreCss() {
    ...
    for (var k = 0; k < VP.length; k++) {
      plain.push('body.theme-day ' + VP[k]
        + ',body.theme-day ' + VP[k] + ' *:not(canvas):not([style*="color"])' + VP_KEEP_DARK);
      surf.push('body.theme-day ' + VP[k] + ' *:not(canvas)' + VP_KEEP_DARK);
    }
  ...
  var CSS = [
    ...
    'body.theme-day .eff-dark-card[style*="color:#fff"],',
    'body.theme-day .eff-dark-card[style*="color: #fff"],',
    'body.theme-day .eff-dark-card[style*="color:#ffffff"],',
    'body.theme-day .eff-dark-card[style*="color: #ffffff"],',
    'body.theme-day .eff-dark-card [style*="color:#fff"],',
    'body.theme-day .eff-dark-card [style*="color: #fff"],',
    'body.theme-day .eff-dark-card [style*="color:#ffffff"],',
    ...
    'body.theme-day .aro3di-view,body.theme-day .aro3di-canvas,',
    ...
    'body.theme-day .wb-canvas-wrap:not(.wb-bg-user),body.theme-day .wb-canvas:not(.wb-bg-user),',
    'body.theme-day #wb-svg:not(.wb-bg-user){background:#ffffff !important;background-image:none !important;}',
    ...
    'body.theme-day [id$="3dblock"] .aln-scale *{color:' + DAY.text + ' !important;}',
    ...
    'body.theme-day #pump-end-slogan{',
    ...
    'body.theme-day #pump-end-slogan > div:nth-child(1){color:#15803d !important;}',
    'body.theme-day #pump-end-slogan > div:nth-child(3){color:#1e293b !important;}',
    'body.theme-day #pump-end-slogan > div:nth-child(4){color:#64748b !important;}',
    ...
    'body.theme-day{scrollbar-color:' + DAY.borderStrong + ' ' + DAY.workspace + ';scrollbar-width:auto;}',
