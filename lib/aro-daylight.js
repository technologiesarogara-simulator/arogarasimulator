...
(function () {
  ...
  var CSS = [
    ...
    'body.theme-day .cav-status-card.status-ok,body.theme-day .aro-st-pass{',
    ...
    'body.theme-day .cav-status-card.status-warn,body.theme-day .aro-st-warn{',
    ...
    'body.theme-day .cav-status-card.status-fail,body.theme-day .aro-st-fail{',
