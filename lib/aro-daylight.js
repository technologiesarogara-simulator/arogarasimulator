...
(function () {
  ...
  var DAY = {
    ...
    app:      '#e9edf1',   // outer application ground
    ...
    border:   '#c7ced6',   // standard 1 px rule
    borderStrong: '#aeb7c2',
  ...
  var VP = ['[id$="3dblock"]', '[id$="-3d-container"]', '[id$="-3d-wrapper"]',
            '[id$="-sim-overlay"]', '#pump-canvas', '#wb-3d', '.wb-stage'];
  ...
  var CSS = [
    ...
    'body.theme-day [id$="-sim-overlay"],body.theme-day #wb-canvas,',
    'body.theme-day #wb-3d,body.theme-day .wb-stage{',
    ...
    'body.theme-day #pump-3d-container *:not(canvas),',
    'body.theme-day #wb-3d *:not(canvas){background-color:transparent !important;}',
