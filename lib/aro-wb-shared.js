     ...
     ['control-valve', 'control']].forEach(function (pair) {
      shared(pair[0], function (props) {
        ...
        v.group.userData.portDefs = [
          { id: 'inlet', role: 'in', name: 'Inlet', local: new T.Vector3(0, 0, 0), dir: new T.Vector3(-1, 0, 0) },
          { id: 'outlet', role: 'out', name: 'Outlet', local: new T.Vector3(v.len, 0, 0), dir: new T.Vector3(1, 0, 0) }
        ];
        return v.group;
