  ...
  function canvasImgs(specs) {
    ...
    specs.forEach(function (s) {
      try {
        ...
        if (cnv && cnv.width) {
          out += '<div style="margin:0 0 10px;"><div style="font-size:9px;font-weight:700;color:#4b5563;margin-bottom:3px;">'
    ...
    try {
      ...
      if (id === 'dphe') {
        ...
        if (d && window.buildDPHESVGDiagram && isFinite(d.Di)) {
          ...
          return '<div style="border:1px solid #d1d5db;padding:6px;background:#fff;">' + svg + '</div>'
            + '<div style="font-size:9px;color:#4b5563;margin-top:5px;text-align:center;">System schematic — hairpin stack, flow direction and duty, drawn from this calculation.</div>';
        }
      }
      ...
      if (id === 'pump' && window.buildPumpSVGDiagram && window.state && window.state.pump
        ...
        return '<div style="text-align:center;border:1px solid #d1d5db;padding:6px;background:#fff;">' + svgP + '</div>'
          + '<div style="font-size:9px;color:#4b5563;margin-top:5px;text-align:center;">Elevation schematic — suction/discharge arrangement, drawn from this calculation.</div>';
      }
      ...
      if (/^line-/.test(id) && window.AROPID) {
        ...
        if (i2p || i3p) {
          ...
          if (i2p) outPid += '<div style="text-align:center;margin:8px 0;"><img src="' + i2p + '" style="max-width:100%;border:1px solid #cbd5e1;border-radius:4px;"/>'
            + '<div style="font-size:9px;color:#4b5563;margin-top:3px;">2D P&amp;ID as drawn — leg lengths, sizes, tags and components</div></div>';
          if (i3p) outPid += '<div style="text-align:center;margin:8px 0;"><img src="' + i3p + '" style="max-width:100%;border:1px solid #cbd5e1;border-radius:4px;"/>'
            + '<div style="font-size:9px;color:#4b5563;margin-top:3px;">3D model of the same route — bore, run length and components follow the sketch</div></div>';
          return outPid;
        }
      }
    } catch (e) {}
  ...
  function reportHtml(id) {
    ...
    if (graphs) {
      ...
      h += sec((5 + nSec) + ' · PERFORMANCE GRAPHS',
        '<div style="font-size:9px;color:#4b5563;margin-bottom:6px;">The same charts the module\'s own '
