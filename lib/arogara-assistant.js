/* ═══════════════════════════════════════════════════════════════════════
   ...
   Global floating AI assistant for AROGARA.
   Two brains:
...
(function () {
  ...
  function askClaude(userText, done, fail, imgs) {
    var sys = 'You are ARO AI, the expert process-engineering copilot inside AROGARA, '
  ...
  function build() {
    ...
    panel.innerHTML = ''
      ...
      + '</div>'
      + '<div class="aro-ai-foot" id="aro-ai-foot">ARO AI · AROGARA COPILOT</div>'
