...
(function () {
  ...
  /* full graph pack (coupled to the current design) — used in output panel,
     ...
     of this panel. Stacking them one per row, capped at a max-width close
     to their native viewBox size, keeps each chart at (or near) 1:1 scale
     on a normal screen instead of either extreme — small and packed, or
     stretched oversized on an ultra-wide panel. */
  function buildGraphs(r) {
    ...
    return '<div style="display:flex;flex-direction:column;gap:16px;">'
      + '<div style="max-width:760px;width:100%;margin:0 auto;">' + gTempProfile(r, chartPrefs('phe-graph-temp')) + '</div>'
      + '<div style="max-width:760px;width:100%;margin:0 auto;">' + gCoeffs(r, chartPrefs('phe-graph-coeffs')) + '</div>'
      + '<div style="max-width:760px;width:100%;margin:0 auto;">' + gDpSweep(r, chartPrefs('phe-graph-dp')) + '</div>'
      + '</div>';
  }
