...
(function () {
  ...
  function calc() {
    ...
    var tag = $('phe-3dtag'); if (tag) tag.textContent = (pheView === 'flow' ? 'INTERNAL FLOW · ' : '') + displayConfig.N + ' plates · ' + (displayConfig.N - 1) + ' channels · ' + U(displayConfig.Q / 1000, 'heat-duty', 0) + ' · ' + (val('phe-ptype', 'Chevron') ) + configLabel;
  ...
  window.AROPHE = { calc: calc, compute: compute, report: report, drawing: drawing,
    ...
    sideClass: sideClass, uBand: uBand };
