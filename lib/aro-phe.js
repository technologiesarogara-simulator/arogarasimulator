...
(function () {
  ...
  function panelHTML() {
    ...
    h += twoCol(fld('Mass flow', 'phe-hf-m', 'kg/s', 10), fld('Mass flow', 'phe-cf-m', 'kg/s', 12));
    h += twoCol(fld('Temperature IN', 'phe-hf-tin', '°C', 90), fld('Temperature IN', 'phe-cf-tin', '°C', 30));
    h += twoCol(fld('Temperature OUT', 'phe-hf-tout', '°C', 55), fld('Temperature OUT', 'phe-cf-tout', '°C', 50));
    h += twoCol(fld('Op. Pressure (0=auto)', 'phe-hf-pdes', 'barg', 10), fld('Op. Pressure (0=auto)', 'phe-cf-pdes', 'barg', 10));
  ...
  function update3D(r) {
    ...
    three.nozWorld = {
      hin:  new THREE.Vector3(x0 - 1.9, PH - 0.5, PW / 2 - 0.8),
      hout: new THREE.Vector3(x0 - 1.9, 1.3, PW / 2 - 0.8),
      cin:  new THREE.Vector3(x0 - 1.9, PH - 0.5, -PW / 2 + 0.8),
      cout: new THREE.Vector3(x0 - 1.9, 1.3, -PW / 2 + 0.8)
    };
    // feet
